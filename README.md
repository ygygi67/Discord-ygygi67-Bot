...
- ✅ อัปเกรดระบบ **Vocal Separator (`/แยกเสียงร้อง`)**:
  - เพิ่มระบบ **Session Resilience**: ทนทานต่อการหลุดของ Discord Gateway หรือ Session Closed ระหว่างแยกเสียง (ระบบจะ Safe Send/Edit อัตโนมัติ)
  - เพิ่มคำสั่ง `/เช็คคิวแยกเสียง` สำหรับดูสถิติและสถานะคิวงานทั้งหมด
  - จำกัดการรัน AI พร้อมกัน (Semaphore) เพื่อความเสถียรของเครื่องเซิร์ฟเวอร์
